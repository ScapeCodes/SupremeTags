...
public class ConfigManager {
    ...
    public void loadTagsFolder() {
        ...
        // --- Prepare the countries.yml file used for runtime-created tags ---
        countriesTagsFile = new File(tagsFolder, "countries.yml");
        if (!countriesTagsFile.exists()) {
            try {
                countriesTagsFile.createNewFile();
            } catch (IOException e) {
                plugin.getLogger().severe("[SupremeTags] Could not create tags/countries.yml: " + e.getMessage());
            }
        }
    ...
    /**
     * Returns all tag file paths relative to the tags/ folder, including subfolders.
     * e.g. ["countries.yml", "default.yml", "subfolder/custom.yml"]
     */
    ...
    /**
     * Gets or creates the countries.yml configuration.
     */
    ...
    /**
     * Returns the config for writing new tags (countries.yml).
     */
    ...
    /**
     * Gets or creates a tag config file in the tags/ folder.
     *
     * @param fileName the name of the file (e.g. "custom.yml")
     * @return the YamlConfiguration for the file
     */
    public YamlConfiguration getOrCreateTagConfig(String fileName) {
        ...
        // Create or load the file (supports subfolder paths like "subfolder/custom.yml")
        ...
        if (!file.exists()) {
            try {
                ...
                return getTagConfigForWrite(); // fallback to default
            }
        }
