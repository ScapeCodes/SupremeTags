...
public class CategoryMenu extends Paged {
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        if (nbt.hasTag("identifier")) {
            ...
            boolean isCostCategory = SupremeTags.getInstance().getCategoryManager().getCatConfig().getBoolean("categories." + menuUtil.getCategory() + ".cost-category");
            ...
            if (hasPerm) {
                ...
                if ((isCostTag || isCostCategory) && hasAmount(player, t.getEconomy().getType(), t.getEconomy().getAmount())) {
